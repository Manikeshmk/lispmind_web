...
var i_14509 = (self__.level + (1));
while(true){
if((i_14509 <= (new_level + (1)))){
(update[i_14509] = self__.header);

var G__14511 = (i_14509 + (1));
i_14509 = G__14511;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14512 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14512[i]));
} else {
x__$2.forward.push((((i < links_14512.length))?(links_14512[i]):null));
}

if((i < links_14512.length)){
(links_14512[i] = x__$2);
} else {
links_14512.push(x__$2);
}
...
var i_14514 = (0);
while(true){
if((i_14514 <= self__.level)){
var links_14515 = (update[i_14514]).forward;
if((x__$1 === (((i_14514 < links_14515.length))?(links_14515[i_14514]):null))){
(links_14515[i_14514] = (x__$1.forward[i_14514]));

var G__14516 = (i_14514 + (1));
i_14514 = G__14516;
continue;
} else {
var G__14517 = (i_14514 + (1));
i_14514 = G__14517;
continue;
}
} else {
...
var G__14519 = nx;
var G__14520 = (level__$1 - (1));
x = G__14519;
level__$1 = G__14520;
continue;
} else {
var G__14521 = x;
var G__14522 = (level__$1 - (1));
x = G__14521;
level__$1 = G__14522;
continue;
}
